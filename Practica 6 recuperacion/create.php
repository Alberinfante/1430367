...
<title>CRUD ALUMNO/MAESTRO</title>
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Agregar <b>Maestro</b></h2></div>
                    <div class="col-sm-4">
            ...
            <?php
				...
				if(isset($_POST) && !empty($_POST)){
					...
					$res = $maestros->createMaestro($nombres, $apellidos, $correo_electronico, $carrera);
					if($res){
        ...
        <div class="table-wrapper">
            ...
            <?php
				...
				if(isset($_POST) && !empty($_POST)){
					...
					$res = $alumnos->createAlumno($nombres, $apellidos, $correo_electronico, $carrera);
					if($res){
						$message= "Datos insertados con éxito";
						$class="alert alert-success";
					}else{
